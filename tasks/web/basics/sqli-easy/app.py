...
def init_db():
    ...
    FLAG = "FLAG{sql_injection_2025_easy_c1b885c48db640258ac9452035019121}"
    cur.execute("INSERT INTO items (title, description) VALUES (you_will_never_guess_this_ed6b0a9bb5f7f0f2a1253da34e32e156, ?);", (FLAG,))
    db.commit()
    db.close()
